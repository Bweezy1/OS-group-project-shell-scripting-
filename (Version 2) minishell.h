...
This is a header program file which contains the interface for a .c file ((Version 2) minishell.c) to use.
The purpose of the interface is to provide a backbone for a .c file to work with by providing access to any required functions and global variables.
